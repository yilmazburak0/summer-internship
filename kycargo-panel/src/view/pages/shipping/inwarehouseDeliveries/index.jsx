...
import { getColumns } from "./inwarehouseDeliveryFields";
import DeliveryCreateEdit from "./modals/inwarehouseDeliveryCreateEdit";
...
export default function Deliveries() {
    ...
    useEffect(() => {
        setReceivedDeliveries(deliveries.filter(delivery => delivery.status === 'Depoda'))
    }, [deliveries])
