...
const inwarehouseDeliveryFields = [
    {
        title: "Alıcı",
        dataIndex: "receiver",
        key: "receiver",
...
export function getColumns(userRole) {
    return inwarehouseDeliveryFields.filter(c => c.colVisible !== false && renderOrNot(c?.role, userRole))
}
...
export default inwarehouseDeliveryFields