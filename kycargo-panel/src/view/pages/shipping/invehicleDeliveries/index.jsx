...
import { getColumns } from "./invehicleDeliveryFields";
import DeliveryCreateEdit from "./modals/invehicleDeliveryCreateEdit";
...
export default function Deliveries() {
    ...
    useEffect(() => {
        setReceivedDeliveries(deliveries.filter(delivery => delivery.status === 'Araca Yüklü'))
    }, [deliveries])
