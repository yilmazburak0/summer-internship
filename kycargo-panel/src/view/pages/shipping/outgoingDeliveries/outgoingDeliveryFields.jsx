...
export function getColumns(userRole) {
    return outgoingDeliveryFields.filter(c => c.colVisible !== false && renderOrNot(c?.role, userRole))
}
...
export default outgoingDeliveryFields