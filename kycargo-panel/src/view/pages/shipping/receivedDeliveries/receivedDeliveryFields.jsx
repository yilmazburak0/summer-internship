...
export function getColumns(userRole) {
    return receivedDeliveryFields.filter(c => c.colVisible !== false && renderOrNot(c?.role, userRole))
}
...
export default receivedDeliveryFields