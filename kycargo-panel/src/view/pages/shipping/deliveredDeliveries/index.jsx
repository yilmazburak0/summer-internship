...
import { getColumns } from "./deliveredDeliveryFields";
import DeliveryCreateEdit from "./modals/deliveredDeliveryCreateEdit";
...
export default function Deliveries() {
    ...
    useEffect(() => {
        setReceivedDeliveries(deliveries.filter(delivery => delivery.status === 'Teslim Edildi'))
    }, [deliveries])
        ...
        <Card className="hp-border-color-black-40">
            ...
            <Row>
                <Col className="hp-mb-16" lg={12} md={12}>
                    <h4>Teslim Edilen Gönderiler</h4>
                </Col>
